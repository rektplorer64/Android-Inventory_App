...
import tanawinwichitcom.android.inventoryapp.rvadapters.itemdecoration.MarginItemDecoration;
import tanawinwichitcom.android.inventoryapp.rvadapters.itemdecoration.PaddingLeftDecoration;
...
public class ListLayoutPreference{
    ...
    public static ListLayoutPreference loadFromSharedPreference(Context c){
        ...
        viewModePref.setTotalColumn(sharedPreferences.getInt(c.getString(R.string.pref_title_column_grid), 2));
