...
public class HelperUtilities{
    ...
    public static boolean isScreenLargeOrPortrait(Context context){
        return HelperUtilities.getScreenSizeCategory(context) < HelperUtilities.SCREENSIZE_LARGE
                || HelperUtilities.getScreenOrientation(context) == HelperUtilities.SCREENORIENTATION_PORTRAIT;
    }
    ...
    public static void expandActionBarToFitStatusBar(Toolbar toolbar, Context context){
        ...
        toolbar.setPadding(0, HelperUtilities.getStatusBarHeight(context), 0, 0);
        ...
        layoutParams.height = HelperUtilities.getStatusBarHeight(context) + actionBarHeight;
