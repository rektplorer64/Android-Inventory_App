...
public class ItemInfoAdapter extends RecyclerView.Adapter<ItemInfoAdapter.InfoViewHolder>{
    ...
    public void onBindViewHolder(@NonNull InfoViewHolder holder, int position){
        ...
        Locale locale = HelperUtilities.getCurrentLocale(holder.infoTopicTextView.getContext());
                ...
                if(infoHashMap.get(keyInfoName) != null){
                    ...
                    if(keyInfoName.contains("Size")){
                        ...
                        holder.infoValueTextView.setText(new StringBuilder()
                                .append(String.format(HelperUtilities.getCurrentLocale(context), "%.2f", fileSizeMB))
                                .append(" MB").toString());
    ...
    public void applyReviewsChanges(String totalReview, double averageRating){
        ...
        infoHashMap.put("Average Rating", String.format(HelperUtilities.getCurrentLocale(context), "%.2f", averageRating));
        notifyDataSetChanged();
    }
