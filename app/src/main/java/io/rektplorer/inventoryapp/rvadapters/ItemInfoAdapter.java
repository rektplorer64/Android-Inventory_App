...
public class ItemInfoAdapter extends RecyclerView.Adapter<ItemInfoAdapter.InfoViewHolder>{
    ...
    public void applyInfoDataChanges(Item item){
        ...
        // infoHashMap.put("Image Size", (item.getHeroImage() != null) ? item.getHeroImage().getPath() : null);
        // infoHashMap.put("Image Resolution", (item.getHeroImage() != null) ? item.getHeroImage().getPath() : null);
